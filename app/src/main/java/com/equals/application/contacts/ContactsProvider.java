package com.equals.application.contacts;
...
import com.equals.application.util.PhoneUtil;
...
public class ContactsProvider {
    ...
    public @Nullable Cursor getSystemContacts(Context context) {
        Cursor cursor;
        try {
    ...
    public @Nullable List<SystemContact> getSystemContactsList(Context context, boolean e164format) {
    ...
    public @Nullable Map<Long, SystemContact> getSystemContactMap(Context context, boolean e164format) {
